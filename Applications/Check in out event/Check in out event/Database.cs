...
namespace Check_in_out_event
{
    class Database
    {
        ...
        public void CheckIn(int id)
        {
            ...
            try
            {
                string sql = "UPDATE dbi413156 . account SET checked_event = 1 WHERE Id = @id";
                connection.Open();
        ...
        public void CheckOut(int id)
        {
            ...
            try
            {
                string sql = "UPDATE dbi413156 . account SET checked_event = 0 WHERE Id = @id";
                connection.Open();
                MySqlCommand command = new MySqlCommand(sql, connection);
                command.Parameters.AddWithValue("id", id);
                command.ExecuteScalar();
